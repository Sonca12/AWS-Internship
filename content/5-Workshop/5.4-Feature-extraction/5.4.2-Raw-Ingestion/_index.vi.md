...
![Mở AWS Glue ETL jobs](https://raw.githubusercontent.com/Sonca12/AWS-Internship/main/static/images/5-Workshop/5.4-Feature-extraction/5.4.2-step01-glue-console.png)

2. Đặt tên Job trong tab **Job details** là `de-fashion-rds-extract` và chọn IAM Role phù hợp là `de-fashion-glue-role`.

![Cấu hình tên và Role cho Job](https://raw.githubusercontent.com/Sonca12/AWS-Internship/main/static/images/5-Workshop/5.4-Feature-extraction/5.4.2-step03-job-name.png)

3. Cấu hình **Python version** là `Python 3.9` hoặc phiên bản mới hơn.

![Cấu hình Python Version](https://raw.githubusercontent.com/Sonca12/AWS-Internship/main/static/images/5-Workshop/5.4-Feature-extraction/5.4.2-step04-python-version.png)
...
![Cấu hình Job Parameters](https://raw.githubusercontent.com/Sonca12/AWS-Internship/main/static/images/5-Workshop/5.4-Feature-extraction/5.4.2-step06-job-parameters.png)