...
1. **Step 1:** In the **Load Balancing** section of the EC2 service dashboard, click **Target groups**. Click **Create target group**:
   ...
   * Click **Next** to proceed to the next step.
   ...
   ![Create Target Group](https://raw.githubusercontent.com/Sonca12/AWS-Internship/main/static/images/5-Workshop/5.2-Network-setup/4-Step1.png)
2. **Step 2:** Register servers (Targets) to the group:
   ...
   * Review the list under **Review targets** and click **Create target group**.
   ...
   ![Register Targets](https://raw.githubusercontent.com/Sonca12/AWS-Internship/main/static/images/5-Workshop/5.2-Network-setup/4-Step2.png)
