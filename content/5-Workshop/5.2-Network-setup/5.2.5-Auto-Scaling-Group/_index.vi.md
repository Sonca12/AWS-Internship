...
1. **Bước 1:** Tại dịch vụ EC2, chọn **Auto Scaling groups** và nhấn **Create Auto Scaling group**:
   ...
   * Nhấn **Next**.
   ...
   ![Create ASG](https://raw.githubusercontent.com/Sonca12/AWS-Internship/main/static/images/5-Workshop/5.2-Network-setup/5-Step1.png)
2. **Bước 2:** Tại **Step 2: Choose instance launch options**, cấu hình tài nguyên tối thiểu và tối đa cho các máy chủ tự động tăng trưởng:
   * Chọn thuộc tính vCPUs từ 1 đến 5 và dung lượng RAM (Memory) từ 1 đến 5 GiB.
   ...
   ![ASG Launch Options](https://raw.githubusercontent.com/Sonca12/AWS-Internship/main/static/images/5-Workshop/5.2-Network-setup/5-Step2.png)
3. **Bước 3:** Chọn VPC và cấu hình vùng mạng cho Auto Scaling Group:
   ...
   * Nhấn **Next**.
   ...
   ![ASG Network Mappings](https://raw.githubusercontent.com/Sonca12/AWS-Internship/main/static/images/5-Workshop/5.2-Network-setup/5-Step3.png)
4. **Bước 4:** Tại **Step 3: Integrate with other services**, liên kết nhóm Auto Scaling với Load Balancer:
   ...
   * Nhấn **Next**.
   ...
   ![ASG ALB Integration](https://raw.githubusercontent.com/Sonca12/AWS-Internship/main/static/images/5-Workshop/5.2-Network-setup/5-Step4.png)
5. **Bước 5:** Tại **Step 4: Configure group size and scaling**, cấu hình giới hạn số lượng máy chủ:
   ...
   * Nhấn **Next**.
   ...
   ![ASG Group Size and Scaling](https://raw.githubusercontent.com/Sonca12/AWS-Internship/main/static/images/5-Workshop/5.2-Network-setup/5-Step5.png)
6. **Bước 6:** Tại **Step 5: Add notifications**, nhấn **Next** để bỏ qua phần cấu hình gửi thông báo qua SNS (hoặc thiết lập nếu bạn muốn nhận cảnh báo khi hệ thống thay đổi quy mô).
   ...
   ![ASG Notifications](https://raw.githubusercontent.com/Sonca12/AWS-Internship/main/static/images/5-Workshop/5.2-Network-setup/5-Step6.png)
7. **Bước 7:** Tại **Step 7: Review**, kiểm tra kỹ lưỡng các cài đặt cấu hình nhóm Auto Scaling Group của bạn và nhấn nút **Create Auto Scaling group** để chính thức kích hoạt.
   ...
   ![ASG Review and Create](https://raw.githubusercontent.com/Sonca12/AWS-Internship/main/static/images/5-Workshop/5.2-Network-setup/5-Step7.png)
